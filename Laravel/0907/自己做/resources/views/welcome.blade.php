                ...
                <div class="accordion-item">
                  ...
                  <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                    <div class="accordion-body fs-6-7">
                      ...
                      <a class="dropdown-item" href="#">Dashboard 4</a>
                      <a class="dropdown-item" href="#">Dashboard 5<span class="badge light-blue ms-1">New</span></a>
                ...
                <div class="accordion-item">
                  ...
                  <div id="collapseSix" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div class="accordion-body fs-6-7">
                      ...
                      <a class="dropdown-item" href="#">Dashboard 5<span class="badge light-blue ms-1">New</span>
                      </a>
                    </div>
                  </div>
                </div>
        ...
        <ul class="top-nav-menu d-flex p-0 m-0">
          <li class="top-nav-item">
            <div class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="#">Dashboard 1</a></li>
                <li><a class="dropdown-item" href="#">Dashboard 2</a></li>
                <li><a class="dropdown-item" href="#">Dashboard 3</a></li>
                <li><a class="dropdown-item" href="#">Dashboard 4</a></li>
                <li><a class="dropdown-item" href="#">Dashboard 5<span class="badge light-blue ms-1">New</span>
                  </a></li>
              </ul>
            </div>
          </li>
