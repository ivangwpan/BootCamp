...
Route::middleware(['auth','role.weight: 2'])->prefix('/shoppingcart')->group(function(){
    Route::get('/frontpage',[OrderlistController::class,'frontpage'])->name('orderlist.frontpage');
    Route::get('/addresspage',[OrderlistController::class,'addresspage'])->name('orderlist.addresspage');
    Route::get('/paymentpage',[OrderlistController::class,'paymentpage'])->name('orderlist.paymentpage');
    Route::get('/thankpage',[OrderlistController::class,'thankpage'])->name('orderlist.thankpage');
});