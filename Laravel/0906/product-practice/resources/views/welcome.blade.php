                    ...
                    <div class="carousel-item">
                        <div class="card ">
                            ...
                            <div class="card-img-overlay d-flex flex-column justify-content-center w-50 ms-5 ps-3">
                                ...
                                <button type="button" class="btn btn-dark text-start " style="width: 120px;"><small>
                                        sohw now<small><img src="{{ asset('image/arrow-right-short.svg') }}"
                                                alt="" class="ms-2 "></small></small>
            ...
            <div class="container">
                <div class="row row-cols">
                    ...
                    <div class="col"><!--麵包卡片-->
                        <div class="p-3">
                            <div class="card ">
                                <img src="{{ asset('image/grocery-banner-2.jpg') }}" class="card-img"
                                    alt="...">
                                <div class="card-img-overlay text-start d-flex flex-column  justify-content-center">
            ...
            <div class="row align-items-start">
                ...
                <div class="col-xl-3">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <p>
                                Choose from 5000+ products across food, personal care, household, bakery, veg and
                                non-veg & other
                                categories.
                            </p>
                        </div>
