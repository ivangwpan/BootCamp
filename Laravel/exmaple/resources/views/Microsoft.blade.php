...
<body>
    <div class="text-[72px] bg-[#12345d] desktop:bg-red-500">{{ $name }}</div>
    <div class="nav">
        <div class="nav-container">
            ...
            <ul id="nav-left">
                ...
                <a href="https://www.microsoft.com/zh-tw/microsoft-teams/group-chat-software?rtc=1">
                    <li>Teams</li>
                </a>
            ...
            <label for="menu" class="menu-list">
                <span>所有 Microsoft <img src="./img/chevron-down-solid.svg" alt="" /></span>
            </label>
            ...
            <div class="menubox-all">
                ...
                <div id="menu-map">
                    <a href="https://www.microsoft.com/zh-tw/sitemap.aspx">檢視網站地圖<span>></span></a>
                </div>
            </div>
    ...
    <div class="swiper mySwiper">
        <div class="swiper-wrapper">
            <div id="swiper-1" class="swiper-slide">
                <picture>
                    <source media="(min-width: 1400px)" class="aa"
                        srcset="
              ...
              " />
                    <img src="./img/first/Highlight-Surface-Pro-9-M1-Family-02-1_VP2-859x540.avif" />
            ...
            <div id="swiper-2" class="swiper-slide">
              ...
              " />
                    <img src="./img/second/Highlight-M365-Icon-Bounce-Word-Merch_VP2-859x540.avif" />
                    <div class="banner-3-paste">
                        <a
    ...
    <div class="main-choice">
        <div>
            <a class="one-choice" id="one-choice-1"
        ...
        <div>
            <a class="one-choice" href="https://www.microsoft.com/zh-tw/surface?icid=MSCOM_QL_Surface">
                <div id="main-choice-img-2"></div>
                <div>選購Surface裝置</div>
            </a>
        </div>
        <div>
            <a class="one-choice" href="https://www.microsoft.com/zh-tw/windows/get-windows-11?icid=MSCOM_QL_Windows">
    ...
    <div class="section-2">
        <div class="banner-2-pic">
            <a href="https://www.xbox.com/zh-tw/consoles/xbox-series-x?icid=mscom_marcom_CPH1a_XboxSeriesX">
                <picture>
                    <source media="(min-width: 1400px)" class="aa" srcset="./img/four-card/min-1400px/1.webp" />
                    <source media="(min-width: 1084px)" srcset="./img/four-card/min-1084px/1.webp" />
                    <source media="(min-width: 860px)" srcset="./img/four-card/min-860px/1.jpg" />
                    <source media="(min-width: 540px)" srcset="./img/four-card/min-540px/1.webp" />
        ...
        <div class="banner-2-pic">
            <a href="https://www.bing.com/new?icid=mscom_marcom_CPH2a_BingAI>">
                <picture>
                    <source media="(min-width: 1400px)" class="aa" srcset="./img/four-card/min-1400px/2.webp" />
                    <source media="(min-width: 1084px)" srcset="./img/four-card/min-1084px/2.webp" />
                    <source media="(min-width: 860px)" srcset="./img/four-card/min-860px/2.webp" />
                    <source media="(min-width: 540px)" srcset="./img/four-card/min-540px/2.webp" />
        ...
        <div class="banner-2-pic">
            <a
                ...
                <picture>
                    <source media="(min-width: 1400px)" class="aa" srcset="./img/four-card/min-1400px/3.avif" />
                    <source media="(min-width: 1084px)" srcset="./img/four-card/min-1084px/3.avif" />
                    <source media="(min-width: 860px)" srcset="./img/four-card/min-860px/3.avif" />
                    <source media="(min-width: 540px)" srcset="./img/four-card/min-540px/3.avif" />
        ...
        <div class="banner-2-pic">
            <a
                ...
                <picture>
                    <source media="(min-width: 1400px)" class="aa" srcset="./img/four-card/min-1400px/4.jpg" />
                    <source media="(min-width: 1084px)" srcset="./img/four-card/min-1084px/4.jpg" />
                    <source media="(min-width: 860px)" srcset="./img/four-card/min-860px/4.avif" />
                    <source media="(min-width: 540px)" srcset="./img/four-card/min-540px/4.jpg" />
    ...
    <div class="section-3">
        <picture>
            <source media="(min-width: 1400px)" class="aa" srcset="./img/section-3/minW-1400.avif" />
            <source media="(min-width: 1084px)" srcset="./img/section-3/minW-1084.avif" />
            <source media="(min-width: 860px)" srcset="./img/section-3/minW-860.avif" />
            <source media="(min-width: 540px)" srcset="./img/section-3/minW-540.avif" />
    ...
    <div class="section-2">
      ...
      <div class="banner-2-pic">
          <a href="https://www.microsoft.com/zh-tw/surface/business?icid=mscom_marcom_CPW1a_SurfaceforBusiness">
              <picture>
                  {{-- <source media="(min-width: 1400px)" class="aa" srcset="./img/section-4/minW-1400/1.avif" />
                  <source media="(min-width: 1084px)" srcset="./img/section-4/minW-1084/1.avif" />
                  <source media="(min-width: 860px)" srcset="./img/section-4/minW-860/1.jpg" />
                  <source media="(min-width: 540px)" srcset="./img/section-4/minW-560/1.avif" /> --}}
                  <img src="{{$item->img_path}}" />
              </picture>
              <div id="banner-2-title">
                  <h3 id="banner-2-h3">{{$item->title}}</h3>
              </div>
              <div>
                  <p>{{$item->content}}</p>
              </div>
    ...
    <div class="section-5">
        <div>關注Microsoft</div>
        <a href="https://www.facebook.com/MicrosoftTaiwan/" target="_blank"><img
                src="./img/section-5/Facebook 2x.avif" /></a>
        <a href="https://www.youtube.com/user/MicrosoftTaiwan" target="_blank"><img
                src="./img/section-5/YouTube 2x.webp" /></a>
    </div>
