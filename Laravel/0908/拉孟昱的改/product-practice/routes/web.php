...
Route::middleware('auth')->get('/user/information',[FrontController::class,'user_info'])->name('user.info');
Route::middleware('auth')->post('/user/information/update',[FrontController::class,'user_info_update'])->name('user.info.update');