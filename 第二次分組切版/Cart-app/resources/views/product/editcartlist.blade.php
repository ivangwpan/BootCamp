                                ...
                                <div class="card-body p-0">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <label class="form-check-label fs-1">產品名稱</label>
                                            <input class="form-check-input me-1 fs-1 w-75" type="text"
                                                name="name" value="{{ $product->name }}" required>
                                        </li>
                                        <li class="list-group-item" style="height: 150px;">
                                            <img style="width: 70px;" src="{{ asset($product->img_path) }}" alt="">
                                            <label class="form-check-label fs-1">產品圖片</label>
                                            <input class="form-check-input me-1 fs-1 w-75" type="file"
                                                value="" name="img_path" style="height: 100px;" accept="image/*">
                                        </li>
                                        <li class="list-group-item">
                                            <label class="form-check-label fs-1">產品價格</label>
                                            <input class="form-check-input me-1 fs-1 w-75" type="number"
                                                name="price" value="{{ $product->price }}" required>
                                        </li>
                                        <li class="list-group-item">
                                            <label class="form-check-label fs-1">顯示狀態</label>
                                            <label class="fs-1">
                                                <input type="radio" id="appear" name="status"
                                                    value="{{ $product->status }}"
                                                    @if ($product->status == 1)  @endif>
                                                要顯示
                                            </label>
                                            <label class="fs-1">
                                                <input type="radio" id="no-appear" name="status"
                                                    value="{{ $product->status }}"
                                                    @if ($product->status == 0)  @endif>
                                                不顯示
                                            </label>
                                        </li>
                                        <li class="list-group-item" style="height: 300px">
                                            <label for="describe" class="form-check-label fs-1">產品描述</label>
                                            <textarea name="describe" class="w-100" style="height: 150px;resize:none;">
                                                {{ $product->describe }}
                                            </textarea>
                                        </li>
                                    </ul>
                                    <div class="btn-group justify-content-center d-flex">
                                        ...
                                        {{-- <a href="{{ route('product.index') }}" class="btn btn-primary m-3">儲存按鈕</a> --}}
