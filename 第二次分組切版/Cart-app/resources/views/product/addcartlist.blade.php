                                    ...
                                    <ul class="list-group">
                                        ...
                                        <li class="list-group-item" style="height: 150px;">
                                            ...
                                            <input class="form-check-input me-1 fs-1 w-75" type="file"
                                                name="img_path" value="" style="height: 100px;" accept="image/*" required>
                                        </li>
                                        <li class="list-group-item">
                                        ...
                                        <li class="list-group-item">
                                            <label class="form-check-label fs-1" for="fourthCheckbox">顯示狀態
                                                <label for="appear" class="fs-1">
                                                    要顯示
                                                    <input type="radio" id="appear" name="status"
                                                        value="1" checked required />
                                                </label>
                                                <label for="no-appear" class="fs-1">
                                                    不顯示
                                        ...
                                        <li class="list-group-item" style="height: 300px">
                                            ...
                                            <textarea name="describe" class="w-100" style="height: 150px;resize:none;"></textarea>
                                        </li>
                                    </ul>
                                    <div class="btn-group justify-content-center d-flex">
                                        <a href="{{ route('product.index') }}" class="btn btn-primary m-3">取消按鈕</a>
                                        {{-- <a href="#" class="btn btn-primary m-3">新增按鈕</a> --}}
