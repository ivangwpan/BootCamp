                                    ...
                                    <div class="col-md-4 col-12 mb-2 mb-md-0 flex-row">
                                        ...
                                        <form class="d-flex" role="search">
                                            ...
                                            <a href="{{ route('product.create') }}" class="btn btn-primary">新增產品按鈕
                                                {{-- <button href="/product/addcartlist" class="btn btn-primary"></button> --}}
                                            </a>
                                        </form>
                                    </div>
                                            ...
                                            @foreach ($products as $product)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($product->status == 0)
                                                            <span
                                                                class="badge bg-light-danger text-dark-primary">。不顯示</span>
                                                        @else
                                                            <span
                                                        ...
                                                        <div class="dropdown">
                                                            <div>
                                                                <form action="{{ route('product.delete', ['id' => $product->id]) }}" method="POST">
                                                                    ...
                                                                    <i class="fa-regular fa-trash-can me-3"></i>刪除</button>
                                                                </form>
                                                            </div>
